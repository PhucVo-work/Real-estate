...
const About = () => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-center justify-center container mx-auto p-10 md:px-20 lg:px-32 w-full"
    >
      <h1 id="aboutSection" className="text-2xl sm:text-4xl font-bold mb-2">
        About{" "}
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start md:gap-20">
        ...
        <div className="flex flex-col items-center md:items-start mt-10 text-gray-600">
          <div className="grid grid-cols-2 gap-6 md:gap-10 w-full 2xl:pr-28">
            ...
            <div>
              <p className="text-4xl font-medium text-gray-800">160+</p>
